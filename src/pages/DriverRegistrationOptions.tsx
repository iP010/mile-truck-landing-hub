...
const DriverRegistrationOptions = () => {
  const { admin } = useAdmin();
  const supabase = getSupabaseClient();
  
  const [activeTab, setActiveTab] = useState<'nationalities' | 'truck_brands' | 'truck_types' | 'vehicle_types'>('nationalities');
  ...
  const tabTitles = {
    ...
    truck_brands: 'ماركات الشاحنات',
    truck_types: 'أنواع الشاحنات',
    vehicle_types: 'أنواع المركبات'
  };

  const tableNames: Record<string, 'driver_nationalities' | 'truck_brands' | 'truck_types' | 'vehicle_types'> = {
    ...
    <div className="min-h-screen bg-background">
      <div className="container mx-auto p-6">
        <div className="mb-6">
          ...
          <h1 className="text-3xl font-bold text-foreground mb-2">إدارة خيارات تسجيل السائقين</h1>
          <p className="text-muted-foreground">إدارة الجنسيات وأنواع الشاحنات والمركبات</p>
        </div>
