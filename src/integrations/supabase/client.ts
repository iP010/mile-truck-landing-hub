...
// دالة fetch مخصصة لإضافة ترويسة session-id على الطلبات للسيرفر
...
// شرح: لا حاجة لأي تغيير في بقية المشروع - الآن جميع العمليات تلقائيًا تعتمد session id في headers!
